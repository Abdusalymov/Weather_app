...
var model = {
  ...
  getCurrentWeather: function getCurrentWeather() {
    var location = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "Москва";
    return axios.get("".concat(url, "weather?q=").concat(location).concat(parameters)).then(function (response) {
  ...
  getCurrentWeatherSeveralLocations: function getCurrentWeatherSeveralLocations() {
    return axios.get("".concat(url, "group?id=511196,5202009,536203,1496747,1486209,520555").concat(parameters)).then(function (response) {
...
},{}]},{},["../Users/irbis/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
//# sourceMappingURL=/Weather%20app.e31bb0bc.js.map